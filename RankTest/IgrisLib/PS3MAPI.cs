...
namespace IgrisLib
{
    ...
    public enum DialogResult
    {
        //
        // Résumé :
        //     Nothing est retourné à partir de la boîte de dialogue. Cela signifie que la boîte
        //     de dialogue modale continue de s’exécuter.
        None = 0,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est OK (généralement transmise par un bouton
        //     intitulé OK).
        OK = 1,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est Cancel (généralement transmise par
        //     un bouton intitulé Annuler).
        Cancel = 2,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est Abort (généralement transmise par un
        //     bouton intitulé Abandonner).
        Abort = 3,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est Retry (généralement transmise par un
        //     bouton intitulé Réessayer).
        Retry = 4,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est Ignore (généralement transmise par
        //     un bouton intitulé Ignorer).
        Ignore = 5,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est Yes (généralement transmise par un
        //     bouton intitulé Oui).
        Yes = 6,
        //
        // Résumé :
        //     La boîte de dialogue valeur de retour est No (généralement transmise par un bouton
        //     intitulé non).
        No = 7
    }
    public class PS3MAPI : IApi, IConnectAPI
    {
        ...
        {
            //ConnectWindow input = new ConnectWindow();
            //try
            //{
            //    bool result = false;
            //    if (input.CustomShow() == DialogResult.OK)
            //    {
            ...
            try
            {
                return new CCAPIWindow(this, this.resources).Show();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message, ex);
        ...
        public bool AttachProcess()
        {
            ...
            //        input = null;
            //    }
            //    input = new AttachWindow(this);
            //    DialogResult dialog_result = input.CustomShow();
            //    if (dialog_result == DialogResult.OK)
            //    {
            //        string[] split = input.cmBProcess.Text.Split(new char[] { '_' });
            //        result = AttachProcess(Convert.ToUInt32(split[0], 16));
            //    }
            //    else if (dialog_result == DialogResult.Retry)
            //    {
            //        goto retry;
            //    }
            //    return result;
        ...
        //LogWindow LogDialog = null;
        ///// <summary>Show log with "LogDialog".</summary>
        //public void ShowLog()
        //{
        //    if (LogDialog == null)
        //        LogDialog = new LogWindow(this);
        //    LogDialog.Show();
        //}
        /// <summary>Show log with "LogDialog".</summary>
        public string Log
